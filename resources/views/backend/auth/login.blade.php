                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('store.login') }}">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="email" name="email" type="email" placeholder="{{ __('name@example.com') }}" />
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                ...
                                <button type="submit" class="btn btn-primary" href="index.html">{{ __('Login') }}</button>
                            </div>
                        </form>
                    </div>
